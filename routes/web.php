...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/appointments/{appointment}/edit', [ClientAppointmentController::class, 'edit'])->name('appointments.edit');
    Route::put('/appointments/{appointment}', [ClientAppointmentController::class, 'update'])->name('appointments.update');
});
